...
function TeamEditList({onShowModal, teamData, changeCurTeamIdx, member}) {
    return (
        ...
        <Scrollbars thumbSize={90} autoHeightMax={"70vh"} autoHeight={true}>
            {
                teamData.map((v,i) => (
                    <div key={i} style={{width:"14vw", height:"30vh", display:"inline", float:"left", marginLeft:"1.6vw", marginTop:"3vh"}}>
            ...
            {
                <div key={10} style={{width:"14vw", height:"23vh", display:"inline", float:"left", marginLeft:"1.3vw", marginTop:"10.3vh"}}>
